		...
		<div class="navbar">
			...
			<ul class="linklist navlinks">
				<li class="icon-home"><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" accesskey="h"><?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?></a> <?php $_navlinks_count = (isset($this->_tpldata['navlinks'])) ? sizeof($this->_tpldata['navlinks']) : 0;if ($_navlinks_count) {for ($_navlinks_i = 0; $_navlinks_i < $_navlinks_count; ++$_navlinks_i){$_navlinks_val = &$this->_tpldata['navlinks'][$_navlinks_i]; ?> <strong>&#8249;</strong> <a href="<?php echo $_navlinks_val['U_VIEW_FORUM']; ?>"><?php echo $_navlinks_val['FORUM_NAME']; ?></a><?php }} ?></li>
				 ...
				 <center>
	<div class="mainwidth">
		<div id="chtibouton"></div>
		<ul class="jaja">
			<li id="nav1"><a href="acceuil_forum.php" title="Home sweet home...">ACCEUIL</a></li>
			<li id="nav2"><a href="index1.php" title="lancons des discussions sur le SAP et posez vos problemes !">FORUM</a></li>
			<li id="nav3"><a href="documentation_forum.php" title="retrouvez vos tutoriels ici !">DOCUMENTATION</a></li>
			<li id="nav4"><a href="contact_forum.php" title="comment  nous retrouvez!">CONTACT</a></li>
		</ul>
		
			<div id="searchbox">
				<form id="searchposition" method="get" action="http://forums.phpbb-fr.com/documentation/recherche/">
					<p>

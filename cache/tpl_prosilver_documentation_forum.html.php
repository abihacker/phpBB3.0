            ...
            <div class="grid_24">    
                ...
                <div class="box-5">
                	<div>
                       ...
                       <a href="sapFI.html" ><p class="text-1">Financial(SAP FI)</p></a>
                        <p>Le module FI (Financial) contient toutes les écritures des ventes<br/>
						et achats, lesquelles se déversent dans
                    ...
                    <div>
                    	<img src="images/sap1.jpg" alt="" class="img-border" width="100" height="50">
                       <a href="#" ><p class="text-1">Controlling (SAP CO)</p></a>
                    ...
                    <div>
                        ...
                        <a href="#"> <p class="text-1">Material Management(SAP MM)</p></a>
                    ...
                    <div>
                        ...
                        <a href="#"><p class="text-1">Human ressource(SAP HR/HCM)</p></a>
                                     <p>Données de base du personnel Suivi du temps de travail Suivi des carrières Gestion des compétences</br>
                                       Recrutement de personnel Gestion des demandes de déplacement
                                       Suivi des frais de déplacement Gestion de la paie<br/> Employee self-service Manager self-service</p>
                        <!--<a href="#" class="link-1">read more</a>-->
                    </div>
                    <div>
                    	<img src="images/sap-sd-grid.PNG" alt="" class="img-border" width="100" height="50">
                        <a href="#"><p class="text-1">Sale Distribution(SAP SD)</p></a>
                    ...
                    <div class="last">
                       ...
                       <a href="#" <p class="text-1">Devellopment(SAP ABAP)</p></a>
                        ...
                        <a href="#"<p class="text-1">Administration(SAP BASIS)</p></a>
                        <p>ABAP: application for business avdanved programming il s'agit du langage de programmation du systeme qui permet de faciliter
						le travail du consultant en lui offrant une interface</P>
						       conviviale.</p>
                        <!--<a href="#" class="link-1">read more</a>-->
                        ...
                        <a href="#"><p class="text-1">Production Planning(SAP PP)</p></a>
                        ...
                        <a href="#"><p class="text-1">Warehouse Management(SAP WM)</p></a>
                        <p>Le module WM (Warehouse Management) concerne la gestion de la Production conviviale.</p>
						<br/>
						<br/>
                        <!--<a href="#" class="link-1">read more</a>-->
						       <!--<div class="container_24 top-3">-->
							   <div class="last">
                                   <ul class="linklist rightside">
	                                 <li class="icon-rules">
							     <p><a href="#"> telecharger vos documents ici</a></li></p>
								 </ul>
								 </div>
                    </div>
                </div>
